...
> "Para navegar com precisão, você precisa conhecer o mapa." — Esta skill é o guia autoritativo para todas as 20 habilidades e padrões deste repositório.
...
- **Stats-Aware**: Sempre mencionar o número total de skills (20) e suas categorias.
...
flowchart TD
    ...
    Analise --> Catálogo[Consulta ao Catálogo de 20 Skills]
...
2.  **Apresentar o Hub**: Utilizar o `references/skills-catalog.md` para dar um overview das **20 habilidades disponíveis** com diagramas Mermaid.
...
1. **[Skills Catalog](references/skills-catalog.md)** — O mapa autoritativo das 20 habilidades do hub com diagramas Mermaid.
