# Tasks: Multi-Agent Orchestrator

## Phase 1: Design & Protocol
- [ ] Definir o template universal de `handoff.md` [ADR-003]. <!-- id: 1 -->
...
- [ ] Executar teste de fumaça de handoff. <!-- id: 7 -->
- [ ] Registrar ADR-003 formalmente. <!-- id: 8 -->
