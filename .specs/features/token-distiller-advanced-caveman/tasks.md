# Tasks: Token Distiller Advanced Caveman Mode

| Task ID | Description | Status | Evidence |
| :--- | :--- | :--- | :--- |
| **T1** | Refactor `token-distiller/SKILL.md` to document levels (`lite`, `full`, `ultra`), Auto-Clarity, and structured pattern | [x] | SKILL.md updated to v2.4.0 |
