# Roadmap do Projeto Skills Hub

## 2026 Q2: Fundação e Core Skills
- [x] Implementação da Metodologia **SDD v1.3.1** (PRD/RFC/BDD/Mermaid).
- [x] Definição do Core Framework para novas skills.
- [x] Skill **Python com UV** (Gerenciamento ultra-rápido).
- [x] Skill **Architecture v2.0** (Distributed Systems & Fitness Functions).
- [x] Skill **Flutter com FVM** (v2026 standards).
- [x] Skill **Azure DevOps v1.1** (Infrastructure & Governance).
