...
- **Centralized Version Tracking**: Manter um catálogo centralizado com versões atualizadas de todas as 11 skills é essencial para consistência do ecossistema.
