...
def test_sync_functionality():
    ...
    print("🚀 Iniciando teste de integração para o script de sincronização...")
    ...
    try:
        ...
        print("   - Executando scripts/sync_mandates.py...")
        subprocess.run(
        ...
        for agent in agents:
            ...
            if not dst.exists():
                raise AssertionError(
                    f"❌ Falha: Skill não encontrada em {agent}/skills/"
                )
